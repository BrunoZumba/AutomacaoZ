...
g++ -Wall -g -I/usr/local/lib -I$MAIN_PATH/include -I$MAIN_PATH/include/AppClasses -I$MAIN_PATH/src/AppClasses -I$MAIN_PATH/include/CommandClasses -c $MAIN_PATH/src/AppClasses/RecurringActionClass.cpp -o $MAIN_PATH/obj/Debug/src/AppClasses/RecurringActionClass.o
...
g++ -Wall -g -I/usr/local/lib -I$MAIN_PATH/include -I$MAIN_PATH/include/AppClasses -I$MAIN_PATH/src/AppClasses -I$MAIN_PATH/include/CommandClasses -c $MAIN_PATH/src/AppClasses/SensorClass.cpp -o $MAIN_PATH/obj/Debug/src/AppClasses/SensorClass.o
...
g++ -Wall -g -I/usr/local/lib -I$MAIN_PATH/include -I$MAIN_PATH/include/AppClasses -I$MAIN_PATH/src/AppClasses -I$MAIN_PATH/include/CommandClasses -c $MAIN_PATH/src/CommandClasses/SensorCommand.cpp -o $MAIN_PATH/obj/Debug/src/CommandClasses/SensorCommand.o
g++ -Wall -g -I/usr/local/lib -I$MAIN_PATH/include -I$MAIN_PATH/include/AppClasses -I$MAIN_PATH/src/AppClasses -I$MAIN_PATH/include/CommandClasses -c $MAIN_PATH/src/CommandClasses/SensorCommand.cpp -o $MAIN_PATH/obj/Debug/src/CommandClasses/SensorCommand.o
g++ -Wall -g -I/usr/local/lib -I$MAIN_PATH/include -I$MAIN_PATH/include/AppClasses -I$MAIN_PATH/src/AppClasses -I$MAIN_PATH/include/CommandClasses -c $MAIN_PATH/src/CommandClasses/ActionButtonCommand.cpp -o $MAIN_PATH/obj/Debug/src/CommandClasses/ActionButtonCommand.o

g++ -o $MAIN_PATH/bin/Debug/RaspberryServer2 $MAIN_PATH/obj/Debug/main.o $MAIN_PATH/obj/Debug/src/AppClasses/ActionButtonClass.o $MAIN_PATH/obj/Debug/src/AppClasses/ActionClass.o $MAIN_PATH/obj/Debug/src/AppClasses/RecurringActionClass.o $MAIN_PATH/obj/Debug/src/AppClasses/TaskButtonClass.o $MAIN_PATH/obj/Debug/src/AppClasses/TaskClass.o $MAIN_PATH/obj/Debug/src/AppClasses/SensorClass.o $MAIN_PATH/obj/Debug/src/CommandClasses/Command.o $MAIN_PATH/obj/Debug/src/CommandClasses/RecurringActionCommand.o $MAIN_PATH/obj/Debug/src/CommandClasses/SensorCommand.o $MAIN_PATH/obj/Debug/src/CommandClasses/SystemActionCommand.o $MAIN_PATH/obj/Debug/src/CommandClasses/ActionButtonCommand.o $MAIN_PATH/obj/Debug/src/CommandClasses/TaskCommand.o $MAIN_PATH/obj/Debug/src/ConnectionHandler.o $MAIN_PATH/obj/Debug/src/Job.o $MAIN_PATH/obj/Debug/src/ListenThreadPool.o $MAIN_PATH/obj/Debug/src/Util.o $MAIN_PATH/include/rc-switch/RCSwitch.o /usr/local/lib/liblirc_client.so -lpthread -lwiringPi -lrt -lcrypt

#No final da ultima linha, o '-lrt' eh para compilar direito um erro shm_open e -lcrypt o erro 'crypt' com libwiringPi.so
